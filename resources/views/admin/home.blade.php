  ...
  <main class="main-content">
      ...
      <div class="home-container">
        ...
        <div id="program-section">
          <form method="GET" action="{{ route('admin.home') }}#program-section">
              ...
              <div class="program-card" 
                  ...
                  <div class="profile-avatar">
                    <img 
                      ...
                      data-profile-url="{{ route('admin.users.edit', $program->dosen->dosen_id ?? 0) }}"
                    >
                  </div>
                  ...
                  <div class="program-footer">
                    <a href="{{ route('admin.programs.view', $program->program_id) }}" 
    ...
    <div class="profile-modal-content">
        ...
        <div class="modal-footer">
            <a id="modal-profile-link" href="{{ route('admin.users.edit', $program->dosen->dosen_id ?? 0) }}" target="_blank" class="btn btn-outline-danger w-100">
                Edit Profile Role
            </a>
        </div>
      </div>
