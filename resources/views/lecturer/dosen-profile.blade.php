      ...
      <div class="profile-container">
        ...
        <div class="profile-sidebar">
          ...
          <nav class="profile-menu" aria-label="Profile sections">
            <ul role="tablist">
              <li><button role="tab" aria-selected="true" aria-controls="personal-info">Personal Information</button></li>
              <li><button role="tab" aria-selected="false" aria-controls="academic-info">Academic & Professional Info</button></li>
              <li><button role="tab" aria-selected="false" aria-controls="research-info">Research & Publications</button></li>
            </ul>
          </nav>
        </div>
        ...
        <div class="profile-form">
          ...
          <!-- Academic Info -->
          <div id="academic-info" role="tabpanel" hidden>
            <h3>Mata Kuliah</h3>
            <div class="table-container">
              <table>
                <thead>
                  <tr><th>Kode</th><th>Nama Mata Kuliah</th></tr>
                </thead>
                <tbody>
                  @forelse($dosen->mataKuliah ?? [] as $mk)
                    <tr><td>{{ $mk->kode }}</td><td>{{ $mk->nama }}</td></tr>
                  @empty
                    <tr><td colspan="2" style="text-align:center;">Tidak ada data mata kuliah</td></tr>
                  @endforelse
                </tbody>
              </table>
            </div>
          ...
          <!-- Research Info -->
          <div id="research-info" role="tabpanel" hidden>
